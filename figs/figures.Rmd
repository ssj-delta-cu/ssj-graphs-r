...
## Cumulative+standaridized area Lineplot Monthly ET by Model for a single crop for two water years

```{r lineplot_cumET2, echo=FALSE, fig.width = 7, fig.height = 4}
...
for(i in 1:length(crops_2_gen)){
  ...
  #plot
  p <- line_ETxMonths_cumulative2(dsa_legal_data, cropid,  "dsa")
